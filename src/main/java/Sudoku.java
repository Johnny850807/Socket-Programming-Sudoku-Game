...
public class Sudoku implements Serializable {
    ...
    public void generateSolvablePuzzle() {
        ...
        do {
            fillEmptyBoard();
            int randomPointsOfPlacement = random.nextInt(40) + 6;
    ...
    private List<Point> generateRandomDistinctPoints(int numPoints) {
        ...
        return IntStream.range(0, 81).boxed()
                .sorted((n1, n2) -> random.nextBoolean() ? -1 : 1)
    ...
    static class SudokuException extends RuntimeException {
    ...
    static class BoardInvalidException extends SudokuException {
    }

    static class NoSolutionsFoundException extends SudokuException {
    }

    static class InvalidException extends SudokuException {
